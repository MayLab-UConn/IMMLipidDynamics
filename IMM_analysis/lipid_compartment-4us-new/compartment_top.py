...
frac_popc_cyl_def = pd.DataFrame(((frac_popc.iloc[:, 0:8].mean(axis=1))))
print ('checking new cylinder regions')
print (frac_popc_cyl_def)
top_popc_cyl_frac = ((frac_popc_cyl_def-frac_popc_cyl_def.iloc[0,:]))
frac_popc_junc_def = pd.DataFrame(((frac_popc.iloc[:, 9:23].mean(axis=1))))
top_popc_junc_frac = ((frac_popc_junc_def-frac_popc_junc_def.iloc[0,:]))
frac_popc_flat_def = pd.DataFrame(((frac_popc.iloc[:, 23:].mean(axis=1))))
#top_popc_flat = ((total_popc_flat_def-total_popc_flat_def.iloc[0,:]))
top_popc_flat_frac = ((frac_popc_flat_def-frac_popc_flat_def.iloc[0,:]))

np.savetxt('top_popc_cyl.txt',top_popc_cyl_frac)
np.savetxt('top_popc_junc.txt',top_popc_junc_frac)
np.savetxt('top_popc_flat.txt',top_popc_flat_frac)
np.savetxt('top_popc_cyl_def.txt',frac_popc_cyl_def)
np.savetxt('top_popc_junc_def.txt',frac_popc_junc_def)
np.savetxt('top_popc_flat_def.txt',frac_popc_flat_def)
print (PC_fract)
...
frac_test_cyl_def = pd.DataFrame(((frac_test.iloc[:, 0:8].mean(axis=1))))
print ('checking new cylinder regions-test')
top_test_cyl_frac = ((frac_test_cyl_def-frac_test_cyl_def.iloc[0,:]))
frac_test_junc_def = pd.DataFrame(((frac_test.iloc[:, 9:23].mean(axis=1))))
top_test_junc_frac = ((frac_test_junc_def-frac_test_junc_def.iloc[0,:]))
frac_test_flat_def = pd.DataFrame(((frac_test.iloc[:, 23:].mean(axis=1))))
top_test_flat_frac = ((frac_test_flat_def-frac_test_flat_def.iloc[0,:]))
np.savetxt('top_test_cyl.txt',top_test_cyl_frac)
np.savetxt('top_test_junc.txt',top_test_junc_frac)
np.savetxt('top_test_flat.txt',top_test_flat_frac)
np.savetxt('top_test_cyl_def.txt',frac_test_cyl_def)
np.savetxt('top_test_junc_def.txt',frac_test_junc_def)
np.savetxt('top_test_flat_def.txt',frac_test_flat_def)

print (PE_fract)


np.savetxt('top_PC-frac.txt', PC_fract)
np.savetxt('top_PE-frac.txt', PE_fract)
...
print (PE_fraction)
np.savetxt('PE_fraction_top.txt', PE_fraction)
np.savetxt('PE_fraction_mean_top.txt', PE_fraction.mean(axis=0))
